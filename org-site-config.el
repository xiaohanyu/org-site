...
(with-namespace "org-site"
  ...
  (defconst url "http://xiaohanyu.github.io/org-site/"
...
with your real site url.")
  ...
  (defconst author-name "Xiao Hanyu"
    "Author name of the site")

  (defconst author-email "xiaohanyu1988@gmail.com"
    "Author email")
  ...
  ;;; toc of post
  (defconst enable-toc t
    "Enable toc(Table Of Contents) or not")

  ;;; google custom search
  (defconst enable-google-search t
    "Enable google custom search or not")

  ;;; comment system settings
  (defconst enable-comment t
  ...
  (defconst html-publish-dir nil
    "Publishing directory for html files.

If set to nil, then org-site will publish files to a \"publish\" sub directory
